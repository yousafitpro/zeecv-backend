    ...
    <section class="job_container_outer_hero">
        ...
        <div class="container">
            ...
            <div class="job_container_outer_hero_content">
                ...
                <span class="job_container_outer_eyebrow">
                ...
                <h1 class="job_container_outer_hero_title">
                ...
                <p class="job_container_outer_hero_description">

                    Explore the latest job opportunities and discover roles
        ...
        <div class="container">
            ...
            <div class="job_container_outer_header">
                ...
                <div>
                    ...
                    <h2 class="job_container_outer_header_title">
