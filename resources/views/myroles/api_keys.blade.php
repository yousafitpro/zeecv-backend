...
<style>
            ...
            <div class="card-header with-border">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <button class="btn btn-primary btn-sm form-control" data-toggle="modal" data-target="#create_query"> <i class="ti-eye" style="color: var(--primary)" ></i> Show Credentials</button>
                       ...
                       <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                           <div class="modal-content">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{$item->status=='Active'?'##########':$item->api_key}}
                                </td>
                                <td>
                                    <div class="badge {{$item->status=='Active'?'badge-success':'badge-default'}}">{{$item->status}}</div>
                                </td>
                                <td>
                                    {{$item->created_at}}
                                </td>
    ...
    <div class="modal fade" id="create_query" tabindex="-1" role="dialog"
        ...
        <form method="post" action="{{route('api.keys.refresh',request('id'))}}" id="addIp">
            @csrf
