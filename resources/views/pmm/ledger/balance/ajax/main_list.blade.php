                        ...
                        <div class=" mt-2 task_actions" >
                                ...
                                <div class="dropdown pull-right ml-2">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink" >
                                            ...
                                            <a class="dropdown-item" style="cursor: pointer"  href="{{ route('pmm.ledger.balance.update', $item->id) . '?back_url=' . route('pmm.ledger.balance.view') }}"   ><i class="fas fa-edit"></i> Edit / View</a>
                                             @endif
