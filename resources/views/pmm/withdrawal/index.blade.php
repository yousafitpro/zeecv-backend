...
/* padding-top: 2px !important */
        ...
        <div class="card" >
            ...
            <div class="card-body" >
                  ...
                  <form id="saearchForm" action="{{route('pmm.withdrawal.search')}}" method="post"onsubmit="submitSearchForm(event, this)">
                                @csrf
                               ...
                               <div class="page-header">
                                ...
                                <ul class="breadcrumbs">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('pmm.withdrawal.view')}}">Withdrawal</a>
                                    </li>
                                    ...
                                    <div class="col-md-6 filter-icon">
                                      ...
                                      @if(is_has_permission('pmm.withdrawal.add|pmm.withdrawal.full_control'))
                                        <a href="{{route('pmm.withdrawal.add')}}"   class="btn btn-sm btn-primary pull-right m-table-header-btn" > Request Withdrawal</a>
                                        @endif
                            ...
                            <div id="menu-content"   style="display: none;">
                                ...
                                <div class="row no-gutters" >
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-2">
                                        <br>
                                        <a  class="btn  btn-sm form-control" style="border-radius: 0px" href="{{route('pmm.withdrawal.view')}}">Reset</a>
                                    </div>
...
{{-- asdadd --}}
                <div id="list_outer" style="margin-top:0px;">
                    @include('pmm.withdrawal.ajax.main_list')
                </div>
            </div>
            <!-- /.box-body -->
        </div>
