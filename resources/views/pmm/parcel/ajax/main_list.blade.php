                ...
                <tr style="border-bottom: 0.02rem solid #e5e7eb;">
                            ...
                            <div class=" align-items-start mb-1">
                                ...
                                <a href=""
                                   class="m-list-item-link">
                                    <img src="{{$item->payment->link->product->attachment->file_url??''}}" style="width: 40px;border-radius:10px">
                                   <span class="ml-3">
                                    {{ $item->payment->link->product->name ?? 'No Title' }}
                    ...
                    <td>
                        ...
                        <div class=" mt-2 task_actions" >
                                ...
                                <br>
                                      <img class="rounded-circle" data-user-id="{{$item->payment->link->product->user->id}}" onclick="hr_show_employee_card(this)"
                                        src="{{ $item->payment->link->product->user->avatar() }}"
                                        style="width: 25px; height: 25px;margin-right:5px;margin-bottom:5px;cursor: pointer;"
                                        title="{{ $item->payment->link->product->user->name }}">
