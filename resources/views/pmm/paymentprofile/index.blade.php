...
/* padding-top: 2px !important */
        ...
        <div class="card" >
            ...
            <div class="card-body" >
                  ...
                  <form id="saearchForm" action="{{route('pmm.paymentprofile.search')}}" method="post"onsubmit="submitSearchForm(event, this)">
                                @csrf
                                <div class="row no-gutters page-header-outer"   >
                                    <div class="col-md-6">
                               <div class="page-header">
                                <h4 class="page-title">Payment Profiles</h4>
                                <ul class="breadcrumbs">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('pmm.paymentprofile.view')}}">Profiles</a>
                                    </li>
                                    ...
                                    <div class="col-md-6 filter-icon">
                                      ...
                                      @if(is_has_permission('pmm.paymentprofile.add|pmm.paymentprofile.full_control'))
                                        <a href="{{route('pmm.paymentprofile.add')}}"   class="btn btn-sm btn-primary pull-right m-table-header-btn" > Add New</a>
                                        @endif
                            ...
                            <div id="menu-content"   style="display: none;">
                                ...
                                <div class="row no-gutters" >
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-2">
                                        <br>
                                        <a  class="btn  btn-sm form-control" style="border-radius: 0px" href="{{route('pmm.paymentprofile.view')}}">Reset</a>
                                    </div>
...
{{-- asdadd --}}
                <div id="list_outer" style="margin-top:0px;">
                    @include('pmm.paymentprofile.ajax.main_list')
                </div>
            </div>
            <!-- /.box-body -->
        </div>
