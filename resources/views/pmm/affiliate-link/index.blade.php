...
/* padding-top: 2px !important */
        ...
        <div class="card" >
            ...
            <div class="card-body" >
                  ...
                  <form id="saearchForm" action="{{route('pmm.affiliate_links.search')}}" method="post"onsubmit="submitSearchForm(event, this)">
                                @csrf
                               ...
                               <div class="page-header">
                                ...
                                <ul class="breadcrumbs">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('pmm.affiliate_links.view')}}">Links</a>
                                    </li>
                            ...
                            <div id="menu-content"   style="display: none;">
                                ...
                                <div class="row no-gutters" >
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-2">
                                        <br>
                                        <a  class="btn  btn-sm form-control" style="border-radius: 0px" href="{{route('pmm.affiliate_links.view')}}">Reset</a>
                                    </div>
...
{{-- asdadd --}}
                <div id="list_outer" style="margin-top:0px;">
                    @include('pmm.affiliate-link.ajax.main_list')
                </div>
            </div>
            <!-- /.box-body -->
        </div>
