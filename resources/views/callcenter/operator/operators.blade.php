...
<style>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="myTable" class="table table-sm table-bordered table-hover display  margin-top-10 w-p100">
                       ...
                       <form method="post" action="{{route('system.CallCenter.operator.update',$item->id)}}" >
                           @csrf
                           <div class="modal-body">
                               ...
                               <div class="row">
                                   <div class="col-md-12">
                                       <label>Name</label>
                                       <input class="form-control" required value="{{$item->user->name}}" name="name">
                                   </div>
                               </div>
                               ...
                               <div class="row">
                                <div class="col-md-12">
                                    <label>Email</label>
                                    <input disabled class="form-control" required value="{{$item->user->email}}" name="email">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <td>
                                    <div class="dropdown pull-right">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink" >
                                            ...
                                            @endif --}}
                                            @if(is_has_permission('system.CallCenter.operator.update'))
    ...
    <div class="modal fade" id="create_query" tabindex="-1" role="dialog"
        ...
        <form method="post" action="{{route('system.CallCenter.operator.add')}}" id="addIp">
            @csrf
            <div class="modal-body">
