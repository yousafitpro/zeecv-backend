...
<body>
  ...
  <header class="app-header sticky-top d-flex justify-content-between align-items-center px-4 py-2 bg-white">
    ...
    <div class="resume-edit-action-buttons">
      <a  href="{{ route('resume.pdf.preview',request('id')) }}?resume={{ now() }}&resume_token={{ auth()->user()->login_token }}" target="_self" class="btn btn-save btn-preview px-4 rounded-pill" >PDF Preview</a>
