              ...
              <div class="border-bottom">
                  <div class="p-3 bg-light d-flex justify-content-between align-items-start"  style="cursor: pointer;">
                    ...
                    <div class="toggle-icons-outer">
                      ...
                      <i class="fas fa-chevron-down text-muted action-icon icon-toggle icon-toggle-sub" onclick="toggleUpDown(this)" data-toggle="collapse" data-target="#EducaionForm{{ $item->id }}"></i>
                    </div>
                  </div>

                  <!-- Expanded Work Item Form -->
                  <div id="EducaionForm{{ $item->id }}" class="collapse p-3 bg-light">
                    <form class="mt-1" method="post" action="{{ route('resume.education.save') }}"  onsubmit="saveEducation(event,this)">
                      @csrf
                      <input hidden value="{{ $item->id }}" name="item_id">
                      <div class="floating-label-group mb-3">
                        <input type="text" id="degree" name="degree" class="form-control" value="{{ $item->degree}}">
                      ...
                      <div class="floating-label-group mb-3">
                        <input type="text" id="institution" name="institution" class="form-control" value="{{ $item->institution}}">
