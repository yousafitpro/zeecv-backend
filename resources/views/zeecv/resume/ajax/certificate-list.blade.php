              ...
              <div class="border-bottom">
                  <div class="p-3 bg-light d-flex justify-content-between align-items-start"  style="cursor: pointer;">
                    ...
                    <div class="toggle-icons-outer">
                      <i class="far fa-trash-alt text-muted mr-2 " onclick="deleteEducation('{{ route('resume.certificate.delete',$item->id) }}')"></i>
                  ...
                  <div id="EducaionForm{{ $item->id }}" class="collapse p-3 bg-light">
                    <form class="mt-1" method="post" action="{{ route('resume.certificate.save') }}"  onsubmit="saveEducation(event,this)">
                      @csrf
