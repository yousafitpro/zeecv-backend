             ...
             <br>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea  style="width: 100%;height:100px" class="form-control" name="meta_tags" ></textarea>
                    </div>
                </div>
                <br>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea  style="width: 100%;height:200px" class="form-control" name="long_description" ></textarea>
                    </div>
