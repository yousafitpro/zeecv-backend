...
/* padding-top: 2px !important */
        ...
        <div class="card" >
            ...
            <div class="card-body" >
                  ...
                  <form id="saearchForm" action="{{route('pages.page.search')}}" method="post"onsubmit="submitSearchForm(event, this)">
                                @csrf
                               ...
                               <div class="page-header">
                                ...
                                <ul class="breadcrumbs">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('pages.page.view')}}">Pages</a>
                                    </li>
                                    ...
                                    <div class="col-md-6 filter-icon">
                                      ...
                                      @if(is_has_permission('pm.sprints.add|pm.sprints.full_control'))
                                        <a href="{{route('pages.page.add')}}"   class="btn btn-sm btn-primary pull-right m-table-header-btn" > Add New</a>
                                        @endif
                            ...
                            <div id="menu-content"   style="display: none;">
                                ...
                                <div class="row no-gutters" >
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-2">
                                        <br>
                                        <a  class="btn  btn-sm form-control" style="border-radius: 0px" href="{{route('pages.page.view')}}">Reset</a>
                                    </div>
...
{{-- asdadd --}}
                <div id="list_outer" style="margin-top:0px;">
                    @include('page.page.ajax.main_list')
                </div>
            </div>
            <!-- /.box-body -->
        </div>
