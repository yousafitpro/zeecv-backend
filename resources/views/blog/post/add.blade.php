...
<script>
   ...
   $(document).ready(function(){
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="col-md-6">
                <h3 style="text-align: right"> Create Tutorial</h3>
                </div>
        </div>
      <div class="row">
        <div class="col-md-12">
   ...
   <form method="post" action="{{route('blog.posts.addPost')}}" id="create_sprint_form" enctype="multipart/form-data" onsubmit="submitForm(event, this)">
            @csrf
                <div class="row">
