...
Route::prefix('v2/resume')
    ->group(function () {
        Route::post('/update-sort-order', [ResumeController::class,'updateSortOrder'])->name('resume.update.sortorder');
...
Route::any('/mobile-app-login-succcessful/{token}',[MobileAppController::class,'appLoginSuccessful'])->name('app.login.successfull');
