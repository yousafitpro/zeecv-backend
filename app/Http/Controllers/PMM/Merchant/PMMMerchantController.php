...
namespace App\Http\Controllers\PMM\Merchant;
...
class PMMMerchantController extends Controller
{
        public function index()
    {
       ...
       ->latest()->paginate(50);
        return view('pmm.merchant.index',$data);
    ...
    public function search(Request $request)
    {
       ...
       ->latest()
       ->get();
        return view('pmm.merchant.ajax.main_list',$data);

    }
    public function process()
    {

      return PMMMerchant::query();
    }
   ...
   public function add()
    {
        ...
        return view('pmm.merchant.add');
    }


    public function update(Request $request,$id)
    {
        $data['item']=PMMMerchant::isAdmin()->find($id);
        return view('pmm.merchant.update',$data);
    }
    public function logs(Request $request,$id)
    {
        $data['list']=AppLog::where([
         ...
         return view('pmm.merchant.logs.index',$data);
    }
    public function updatePost(Request $request,$id)
    {
        $data=$request->except(['_token']);

        $product = PMMMerchant::find($id);
    ...
    public function remove(Request $request,$id)
    {
       try{
        DB::beginTransaction();
       PMMMerchant::hasPermission('pm.products.full_control')->find($id)->user->delete();
       PMMMerchant::hasPermission('pm.products.full_control')->find($id)->delete();
       DB::commit();
